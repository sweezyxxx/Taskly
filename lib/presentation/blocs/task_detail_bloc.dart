...
class TaskDetailBloc extends Bloc<TaskDetailEvent, TaskDetailState> {
  ...
  TaskDetailBloc({required this.createUseCase, required this.updateUseCase})
  ...
  Future<void> _onSaveTask(
    ...
    try {
      // Depending on the isEditing flag, this will either create a new task 
      // or update an existing one via the corresponding use cases.
      if (event.isEditing) {
